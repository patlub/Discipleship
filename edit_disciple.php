...
<div class="container-fluid">
    ...
    <div class="success-alert row" align="center">Disciple has been edited</div>
    <div id="form-div" class="row">
        <form id="edit-disciple-form" role="form" enctype="multipart/form-data"
              action="php/edit_disciple.php?id=<?php echo $id; ?>">
            ...
            <div class="col-md-3 section-div">
                ...
                <div class="form-group">
                    <div class="row">
                        <input id="future" type="text" name="future"
                               value="<?php echo $disciple->get_ministry_future(); ?>"
                               class="form-control"
